...
from model_structure.diff_utils.helpers import *
from model_diffusion_arch import *
import numpy as np
import os
...
class DiffusionModel_fx(nn.Module):
    def __init__(self, laten_dim = 1024, timesteps=1000, sampling_timesteps=None, beta_schedule='cosine',
        ...
        self.model = DiffusionNet(dim=laten_dim, depth=4)
    ...
    def q_sample(self, x_start, t, noise=None):
        ...
        # a = extract(self.sqrt_alphas_cumprod, t, x_start.shape) * x_start
        # b = extract(self.sqrt_one_minus_alphas_cumprod, t, x_start.shape) * noise
        return (
    ...
    def forward(self, x_start, cond_feature, ret_pred_x=True, noise=None):
        ...
        model_out = self.model(x, t, cond_feature)
